...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO 构造器异常");
        }
    }
    ...
    protected int executeUpdate(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeUpdate异常");
        } finally {
            close(rs, psmt, conn);
        }
    }
    ...
    protected Object[] executeComplexQuery(String sql, Object... params) {
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeComplexQuery异常");
        } finally {
            close(rs, psmt, conn);
        }
        return null;
